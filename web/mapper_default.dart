...
class MapperDefault implements MemoryMapper {
  ...
  MapperDefault(this.nes) : joypadLastWrite = -1 {
  ...
  void loadVromBank(int bank, int address) {
    ...
    // arraycopy(Object src, int srcPos, Object dest, int destPos, int length)
    Util.arraycopy(rom.getVromBank(bank % rom.getVromBankCount()), 0,
        nes.ppuMem.mem, address, 4096);
  ...
  void load1kVromBank(int bank1k, int address) {
    ...
    Util.arraycopy(
        rom.getVromBank(bank4k), 0, nes.ppuMem.mem, bankoffset, 1024);
  ...
  void load2kVromBank(int bank2k, int address) {
    ...
    Util.arraycopy(
        rom.getVromBank(bank4k), bankoffset, nes.ppuMem.mem, address, 2048);
